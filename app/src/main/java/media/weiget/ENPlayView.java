...
public class ENPlayView extends View {
    ...
    public final static int DEFAULT_LINE_COLOR = Color.WHITE;

    public final static int DEFAULT_BG_LINE_COLOR = 0xfffafafa;

    public final static int DEFAULT_LINE_WIDTH = 4;

    public final static int DEFAULT_BG_LINE_WIDTH = 4;
    ...
    public ENPlayView(Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.ENPlayView);
        int lineColor = ta.getColor(R.styleable.ENPlayView_play_line_color, DEFAULT_LINE_COLOR);
        int bgLineColor = ta.getColor(R.styleable.ENPlayView_play_bg_line_color, DEFAULT_BG_LINE_COLOR);
        int lineWidth = ta.getInteger(R.styleable.ENPlayView_play_line_width, dp2px(DEFAULT_LINE_WIDTH));
        int bgLineWidth = ta.getInteger(R.styleable.ENPlayView_play_bg_line_width, dp2px(DEFAULT_BG_LINE_WIDTH));
        ta.recycle();
